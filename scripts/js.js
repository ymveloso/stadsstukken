...
//when running the function, page count is 0
let pageNumber = 0;
...
//conditionals (classList/toggle does not allow hover/messes up the CSS. I'm sorry Javascript Gods, I hope you find forgiveness in your heart)
  if (pageNumber == 0) {
    ...
    // li0Tag.style = "text-decoration: underline;text-decoration-color: #F7A813;"
  } else {
    li0Tag.style.color = "#F7A813"
    // li0Tag.style = "color: #F7A813; text-decoration: none;"
    // li0Tag.classList.remove("selected")
  }

  if (pageNumber == 1) {
    li1Tag.style.color = "#302D7D"
    // li1Tag.style = "text-decoration: underline;text-decoration-color: #F7A813;"
  } else {
    li1Tag.style.color = "#F7A813"
    // li1Tag.style = "text-decoration: none;"
  }
...
// //defines that updating each section is running updateSection on a specific page
// not necessary but kept here for learnig purposes
//
