    <!--
    Colophon
    Graphic Design: Joep Brouwer
    Web Design: Yara Veloso & Joep Brouwer
    Web Developing: Yara Veloso

    https://joepbrouwer.wordpress.com/
    http://yaraveloso.nu
...
<html>
  <head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-140860030-1"></script>
    <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'UA-140860030-1');
  </script>
...
<script>
  ...
  fbq('init', '467576410479156');
  fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
  src="https://www.facebook.com/tr?id=467576410479156&ev=PageView&noscript=1"
/></noscript>
